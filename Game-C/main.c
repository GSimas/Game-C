...
////////////////////////////////////////////////////////////////////////
    ...
    while (!done)
    {
        ...
        else if(ev.type == ALLEGRO_EVENT_TIMER)
        {
            ...
            UpdateShootW(&shootW);
            //UpdateShootE(&shootE);
            ShootQColisionEnemyRed(&shootQ,&enemyred,&size_enemy_red);
            ShootWColisionEnemyBlue(&shootW,&enemyblue,&size_enemy_blue);
            UpdateEnemyRed(&enemyred, &size_enemy_red);
            UpdateEnemyBlue(&enemyblue, &size_enemy_blue);
        }
        ...
        if(redraw && al_is_event_queue_empty(event_queue))
        {
            ...
            DrawShootW(&shootW);
            //DrawShootE(&shootE);
            DrawEnemyRed(&enemyred, &size_enemy_red);
            DrawEnemyBlue(&enemyblue, &size_enemy_blue);
...
void DrawEnemyRed(struct Enemy_red *enemyred, float *size_enemy_red)
{
    if(enemyred->alive)
    {
...
void UpdateEnemyRed(struct Enemy_red *enemyred, float *size_enemy_red)
{
    if(enemyred->alive)
    {
...
void DrawEnemyBlue(struct Enemy_blue *enemyblue, float *size_enemy_blue)
{
    if(enemyblue->alive)
    {
...
void UpdateEnemyBlue(struct Enemy_blue *enemyblue, float *size_enemy_blue)
{
     if(enemyblue->alive)
    {
...
void ShootQColisionEnemyRed(struct Shoot *shootQ, struct Enemy_red *enemyred, float *size_enemy_red)
{
...
void ShootWColisionEnemyBlue(struct Shoot *shootW, struct Enemy_blue *enemyblue, float *size_enemy_blue)
{
...
/*void PlayerColisionEnemyRed(struct Player *player, struct Enemy_red *enemyred, *size_enemy_red){
    enemyred->boundx = *size_enemy_red;
    enemyred->boundy = *size_enemy_red;
    if(enemyred->alive == true){
        if(enemyred->x - enemyred->boundx <= player->x + player->boundx )
